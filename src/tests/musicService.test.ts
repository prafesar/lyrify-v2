...
describe('musicService cache and local persistence regressions', () => {
  ...
  it('splits lyrics into stable indexed line objects', () => {
    ...
    expect(lines).toEqual([
      { id: 'track-42:line:0', lineId: 'line_781e3b91', lineTextHash: 'line_781e3b91', lineKey: '4991ea65', index: 0, original: 'first line', phrases: [] },
      { id: 'track-42:line:1', lineId: 'empty_line', lineTextHash: 'empty_line', lineKey: '811c9dc5', index: 1, original: '', phrases: [] },
      { id: 'track-42:line:2', lineId: 'line_edde7d5b', lineTextHash: 'line_edde7d5b', lineKey: '74ced1a7', index: 2, original: 'second line', phrases: [] },
    ]);
  });
